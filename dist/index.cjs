...
async function main() {
  ...
  await import_mongoose.default.connect(`mongodb+srv://${dbuser}:${dbpass}@cluster0.sanr1fc.mongodb.net/?retryWrites=true&w=majority`);
...
var priceInfo = new import_mongoose2.Schema({
  destination: { type: String, required: true },
  price: { type: Number, required: true }
});
var PricesInformation = (0, import_mongoose2.model)("priceInfos", priceInfo);
...
var user = new import_mongoose3.Schema({
  name: { type: String, required: true },
  login: { type: String, required: true },
  password: { type: String, required: true }
});
var User = (0, import_mongoose3.model)("user", user);
